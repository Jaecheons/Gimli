...
const InitialCard: React.FC<{ onNext: () => void }> = ({ onNext }) => {
  const messages = [
    "Hey Ashlekha",
    "Suprised why tf I made this?",
    "Because you refuse to meet me so I can properly apologize",
    "So I wanted to do this properly"
  ];
      ...
      <div className="bg-blue-600 rounded-3xl shadow-2xl p-8 transform transition-all duration-500 hover:scale-105 max-w-md mx-auto">
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-white font-bold text-xl">Love Grows</h3>
              <p className="text-white/80">Where my Rosemary goes....</p>
            </div>
            <button 
              onClick={togglePlay}
