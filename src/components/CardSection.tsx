...
const CardSection: React.FC<CardSectionProps> = ({ onNext }) => {
  ...
  const cardMessages = [
    "You are very Goyalekha for a reason, but it is kinda cute.",
    "Your quirkiness knows no bounds.",
    "You are rude and that side eye damnnnn, kinda hot ngl.(Am I a fuckin masochist?)",
    "Hope you are well and okay because besi uri phura hekarone iman bah hoi thake tumar",
    "I know I am a piece of shit but I was confused okay maybe I care for you more than I thought I did so needed some thinking to do but yk I am a big idiot."
  ];
