...
import Music5 from '../music/style.mp3';
  ...
  const cards: UnoCardData[] = [
    {
      ...
      number: "1",
      photoUrl: Img5,
      caption: "That gaze I swear. I fear 4 women in my life and you are 3 of them",
      musicName: "Kid in Love",
      musicUrl: Music2,
    },
    {
      color: "bg-blue-500",
      number: "2",
      photoUrl: Img2,
      caption: "Sheesh last thing I needed was to see this pulchritudionousness in traditional.",
      musicName: "O Rangrez",
      musicUrl: Music4,
    },
    {
      ...
      number: "3",
      photoUrl: Img3,
      caption: "I do not say Cutelekha for no reason do I",
      musicName: "I'm in Love with You",
      musicUrl: Music3,
    },
    {
      color: "bg-yellow-500",
      number: "4",
      photoUrl: Img4,
      caption: "I mean this is a cult classic",
      musicName: "Style (The OG)",
      musicUrl: Music5,
    },
    ...
    >
      ...
      {flipped.every((isFlipped) => isFlipped) && (
        <div className="text-center transition-all duration-500">
          ...
          >
            Well, I have written something for you Mou<ChevronRight className="ml-2" />
          </button>
        </div>
      )}
    </div>
